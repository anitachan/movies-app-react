...
describe('TmdbApi', () => {
  ...
  test('should return the cast by movieId', async () => {
    ...
    expect(axiosMock.get).toHaveBeenCalledWith(`${url}movie/${id}/credits`, { "params": { "api_key": key } })
  });
  ...
  test('should return the actor credits', async () => {
    ...
    expect(axiosMock.get).toHaveBeenCalledWith(`${url}person/${id}/movie_credits`, { "params": { "api_key": key } })
  });
